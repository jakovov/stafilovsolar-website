          ...
          <div className="kontaktsection">
            <div className="emailform">
              ...
              <div className="sec-title">
                        <h6 className="sub-title card-title-items">КОНТАКТИРАЈТЕ НЕ</h6>
                        <h2 className='card-title-items'>Стапи во контакт</h2>
                        <p className='card-title-items'>Слободно контактирајте не за какви било прашања или повратни информации. Ние сме тука да помогнеме и секогаш сме желни да слушнеме од вас. Ви благодариме што стапивте во контакт!</p>
                    </div>
